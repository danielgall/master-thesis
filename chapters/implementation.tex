...
name @
  {buffer tests}, apply_rule(name) <=> {actions}, conflict_resolution.
\end{lstlisting}
...
name @
  {buffer tests}, apply_rule(rule(name, {Variables in the head of the rule})) <=> {actions}, conflict_resolution.
\end{lstlisting}
