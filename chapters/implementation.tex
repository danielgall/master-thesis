...
\begin{example}
To clarify the matching concept of ACT-R, here are some examples and their behaviour:
...
will also match chunks with an empty \verb|eggs| slot, if their \verb|spam| slot is not empty.
