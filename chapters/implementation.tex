...
\begin{lstlisting}[caption={Rules for \texttt{add\_chunk}}, label=add_chunk_rules]
...
On top of the rules in listing~\ref{add_chunk_rules}, there must be added a rule that deletes a primitive element (ie. a chunk of type \verb|chunk|), if the user introduces a real chunk with the name of this element:
