...
There are some methods to influence the conflict resolution process using the ACT-R command \verb|(spp ...)| that can set values for individual production rules. This command is translated as described in section~\ref{lisp_functions}. Additionally, there are some configuration variables that can be set -- as described in section~\ref{configuration} -- by the command \verb|(sgp ...)|:
