...
can be translated directly to a CHR rule:
...
The CHR rule only fires, if all the checked buffers hold chunks that meet the requirements specified in the slot tests:
...
\FIXME{unbound variables?? Vermutung: Matcht dann einfach, testen!!}
...
\FIXME{check behaviour for negative slot tests, add examples}
