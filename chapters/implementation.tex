...
\begin{enumerate}
 ...
 \begin{enumerate}
 \item The dequeued event is a \verb|fire| constraint: The rule that matches all its condition is performed and removes the \verb|fire| constraint.
...
with reasonable values for \verb|Duration| and \verb|Priority|.
