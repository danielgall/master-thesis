...
A lot of the information in this chapter is based on \cite{anderson_how_2007}, \cite{anderson_integrated_2004} and \cite{taatgen_modeling_2006}, where a much more comprehensive discussion of the ACT-R theory including complex examples, referrings to the neuro-biology and the reasons why this particular modeling of human cognition has been chosen. In this work, only the basic concepts of ACT-R are presented.
...
\begin{table}[hbt]
\caption{ACT-R's Taxonomy of Learning \cite[pp. 92--95]{anderson_how_2007}}
\begin{center}
\begin{tabular}{|l|ll|}
\hline
