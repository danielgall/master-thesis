...
\tikzstyle{rule}=[rectangle, draw=Uulmin,  
        rounded corners, anchor=west, text=white, text width=9cm]

\begin{center}
\begin{tikzpicture}[node distance=0.5cm]
\node (count-rule) [rule, rectangle split, rectangle split parts=5, rectangle split part fill={Uulmin, Uulmin!45,Uulmin!45,Uulmin!80,Uulmin!80}] {
        \textbf{count-rule}
